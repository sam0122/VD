...
x = -50:0.1:50;
y = (x.^2 -2.*p1.xCoord.*x +p1.xCoord.^2 + p1.yCoord.^2 - p7.yCoord.^2)/(2.*(p1.yCoord-p7.yCoord));
...
plot(p2.xCoord,p2.yCoord,'.');
hold on;
y2 = (x.^2 -2.*p2.xCoord.*x +p2.xCoord.^2 + p2.yCoord.^2 - p7.yCoord.^2)/(2.*(p2.yCoord-p7.yCoord));
hold on;
plot(x,y2,'r');
hold on;
plot(p3.xCoord,p3.yCoord,'.');
y3 = (x.^2 -2.*p3.xCoord.*x +p3.xCoord.^2 + p3.yCoord.^2 - p7.yCoord.^2)/(2.*(p3.yCoord-p7.yCoord));
hold on;
plot(x,y3,'y');
y4 = (x.^2 -2.*p4.xCoord.*x +p4.xCoord.^2 + p4.yCoord.^2 - p7.yCoord.^2)/(2.*(p4.yCoord-p7.yCoord));
hold on;
plot(x,y4,'m');
